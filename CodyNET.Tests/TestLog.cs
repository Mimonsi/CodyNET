...
namespace CodyNET.Utils;

public enum TimeSetting
{
    Absolute, // Shows actual time
    AbsoluteWithDate, // Shows actual time and date
    Relative, // Shows time passed since program start
}
